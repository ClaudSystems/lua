...
class ListVdViewModel {
   ...
   // private ListModelList<Cotacao> selectedItems
    ...
    private List<Item> getAllItems() {
        ...
        for (Vd x:vds){
            if (!x.equals(null)){
                items.add(new Item(x.id,x.cliente.nome, x.valor, x.dateCreated))
            }
    ...
    class Item {
        ...
        Item(Long id,String nome, BigDecimal valor, Date dateCreated) {
            this.id = id
    ...
    void showIt() {
        ...
        composersService.vd =Vd.findById(pickedItem.id)
