...
<?page zscriptLanguage="GroovyGrails"?>
	...
	.togle li.active{
		...
		<div style="background:#EAEAEA " >
			<g:render template="/layout/header"/>

                <g:render template="/_menu/head"/>
	...
	<link rel="stylesheet" href="${resource(dir: 'js', file: 'application.js')}" type="text/js">
	...
	<script>
		...
		function run() {
			...
			document.getElementById("vendas").style.backgroundColor = "#ff0000";
		}
	</script>
	</body>
</html>
