    ...
    <div class="panel panel-default">
      <div class="panel-heading">Saida De Produtos</div>

            <g:form action="imprimirSaidas" class="button-bar" role="form"  >
                ...
                <div class="col-lg-3">
                    <calendar:datePicker  name="inicio_s" precision="day"  defaultValue="${new Date()-30}"  />
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-3">
                        <calendar:datePicker  name="fim_s" precision="day"  defaultValue="${new Date()+1}"  />
                    </div>
