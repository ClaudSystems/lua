  ...
  <div class="panel-heading">VD´s</div>

    <g:form action="imprimirVDs" class="button-bar" role="form"  >
        ...
        <div class="col-lg-3">
            <calendar:datePicker  name="inicio_v" precision="day"  defaultValue="${new Date()-30}"  />
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-3">
                <calendar:datePicker  name="fim_v" precision="day"  defaultValue="${new Date()+1}"  />
            </div>
